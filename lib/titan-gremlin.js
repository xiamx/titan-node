...
var TitanEdgeWrapper = require('./titan-edge-wrapper');
var TitanIndexQuery = require('./titan-index-query-wrapper');
...
var TitanGremlin = module.exports = function (opts) {
  ...
  this.Factory = this.java.import('com.thinkaurelius.titan.core.TitanFactory');
...
TitanGremlin.prototype.wrapIndexQuery = function (val) {
  return new TitanIndexQuery(this, val);
};
