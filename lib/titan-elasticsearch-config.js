...
var ElasticSearchConfig = function (in_params) {
  ...
  if (in_params.sniff) {
    this.current_index.sniff = in_params.sniff;
  } else {
    this.current_index.sniff = true;
  }
};
...
ElasticSearchConfig.prototype.extendBaseConfiguration = function (in_baseConfig) {
  ...
  in_baseConfig.addPropertySync(this.storage_index_path + 'sniff', this.current_index.sniff);
