...
var Mapping = require('./titan-mapping');
...
TitanKeyMakerWrapper.prototype.indexedSync = function (in_indexName,
  ...
  if (in_params) {
    in_params.forEach( function(p) {
      var mapping = java.callStaticMethodSync("com.thinkaurelius.titan.core.Mapping", "valueOf", p.value);
      var parameter = java.callStaticMethodSync(
        'com.thinkaurelius.titan.core.Parameter', 'of', p.key, mapping
      );
      parameters.push(parameter);
    });
  }
  var parametersJava = java.newArray(
    'com.thinkaurelius.titan.core.Parameter',
    parameters
  );

  this.maker.indexedSync(in_indexName, in_clazz, parametersJava);
...
TitanKeyMakerWrapper.prototype.indexed = function (in_indexName,
  ...
  return this.maker.indexed(in_indexName, in_clazz, parametersJava);
};
